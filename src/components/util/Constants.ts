...
export const SET_OPTIONS_TRADES_PAGE = 'SET_OPTIONS_TRADES_PAGE';
export const SAVE_OPTION_TRADES = "SAVE_OPTION_TRADES";
export const EDIT_OPTION_TRADE = "EDIT_OPTION_TRADE";
